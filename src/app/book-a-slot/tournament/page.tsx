      ...
      <div className="px-3 pt-3">
        ...
        <section className="mx-auto grid w-full max-w-[1240px] gap-3 lg:grid-cols-[0.95fr_1.35fr]">
          <article className="rounded-2xl bg-[#f1f3fb] p-3">
            <h2 className="text-2xl">Tournament Information</h2>
            <p className="mt-2 text-[#6e76d8]">Name of Tournament</p>
            <Image src="/assets/Rectangle.png" alt="Tournament" width={500} height={280} className="mt-3 h-[220px] w-full rounded-xl object-cover" />
          ...
          <article className="rounded-2xl bg-[#f1f3fb] p-3">
            ...
            <div className="mt-3 rounded-xl bg-white p-3 text-sm">Tournament Date: 22 Dec 2024 to 22 Dec 2024</div>
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              <div className="rounded-xl bg-white px-3 py-2 text-xs">You</div>
              <div className="rounded-xl bg-white px-3 py-2 text-xs">Joyan <span className="ml-2 rounded-full bg-[#fce9ec] px-2 py-0.5 text-[10px] text-[#eb526d]">Remove</span></div>
            </div>
