...
const DUMMY_BOOKINGS: Record<BookingType, Booking[]> = {
  matches: [
    {
      _id: "match-1",
      venue: {
      ...
      totalSlots: 2,
      status: "Confirmed",
      teamMembers: [{ teamMemberName: "Rahul" }, { teamMemberName: "Arjun" }],
    },
    {
      _id: "match-2",
      venue: {
      ...
      totalSlots: 4,
      status: "Upcoming",
      teamMembers: [{ teamMemberName: "Aman" }, { teamMemberName: "Karan" }, { teamMemberName: "Vikram" }],
    },
  ],
  tournament: [
    {
      ...
      totalSlots: 1,
      status: "Registered",
      teamMembers: [{ teamMemberName: "Neha" }, { teamMemberName: "Priya" }],
    },
    {
      _id: "tour-2",
      venue: {
      ...
      totalSlots: 2,
      status: "Confirmed",
      teamMembers: [{ teamMemberName: "Riya" }, { teamMemberName: "Sana" }, { teamMemberName: "Mitali" }],
    },
  ],
};
...
export default function MyBookingsPage() {
  ...
  useEffect(() => {
    setLoading(true);
    setBookings(DUMMY_BOOKINGS[activeType] ?? []);
    setLoading(false);
  }, [activeType]);
